<template>
  <v-layout justify-center class="mt-5">
    <v-flex xs12 sm8 md4>
      <v-card class="mt-12 elevation-2" v-if="showLoginForm">
        ...
        <v-card-text>
          <v-form>
            <div v-if="!passResetSuccess">
              ...
              ></v-text-field>
              <v-card-actions>
                <a class="body-2 b-link" @click="togglePasswordReset"
                  >Back to login</a
                >
                <v-spacer></v-spacer>
                <v-btn color="info" @click="resetPassword">Submit</v-btn>
              </v-card-actions>
            </div>
            <div v-else>
              <p class="body-1">
              ...
              <v-card-actions>
                <v-spacer></v-spacer>
                <v-btn @click="togglePasswordReset" color="info"
                  >Back to login</v-btn
                >
              </v-card-actions>
            </div>
      ...
      <div class="text-center mt-4">
        <a href="#" class="body-1 b-link">Contact Administrator</a>
      </div>
      <div class="text-center mt-3">
        <a href="#" class="body-1 b-link">Terms and Conditions</a>
      </div>
    </v-flex>
  </v-layout>
</template>
